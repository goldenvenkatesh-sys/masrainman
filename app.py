// ============================================================
// MASRAINMAN
// 6-HOURLY RAINFALL MAP
//
// FEATURES
// ------------------------------------------------------------
// • ECMWF HRES / GEM / GFS / ICON
// • 0.5° display grid
// • 330 × 198 fast rendering grid
// • No blur
// • Reduced smoothing
// • < 1 mm / 6h = transparent
// • Model averaging
...
// ============================================================
// BUILD MODEL-AVERAGED FIELD
// ============================================================

function buildField(period, models) {
...
// MODEL RUN HOUR
//
// data.updated = 2026-09-11T05:04:32Z
//
// Therefore the current completed model cycle is 00Z.
// ============================================================

function getRunHour(timestamp) {
...
// IMPORTANT
// ------------------------------------------------------------
// The data arrays represent SIX-HOUR ACCUMULATION WINDOWS.
//
// Therefore:
//
// period 0 = Run + 6h
...
// period 11 = Run + 72h
//
// We display the END of the selected accumulation period
// as the valid time.
// ============================================================

function getValidTimestamp(period) {
...
function formatValidIST(period) {
...
fetch(
  ...
  .then(
    json => {
      ...
      // Make sure Leaflet knows the actual
      // Blogger container dimensions.
